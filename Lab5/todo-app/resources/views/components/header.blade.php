...
<header class="w-3/4 flex flex-col items-center mx-auto">
    <div
        ...
        <img src="{{ asset('images/logo.svg') }}" class="w-16 h-16 fill-white" alt="logo">
    ...
    "text-green-700  border-transparent" => $isActive === "about",
                    ...
                    <span class="hidden sm:inline-block">User</span></a>
            </li>
            <li>
    ...
    "text-green-700  border-transparent" => $isActive === "about"
                        ...
                        <svg class="h-6 md:h-7 m-auto" xmlns="http://www.w3.org/2000/svg" fill="none"
